...
To gauge learning progress and to access instant feedback, we have incorporated quizzes using (Mentimeter)[https://www.mentimeter.com] into each workshop. The advantage of mentimeter was that it was possible to embed them directly into Notebooks, which meant that polling could happen directly in the learning environment. These polls were used to capture the mood of the group of learners (see Figure 1), but also test their understanding through syntax recap questions at the beginning of a new Unit. Using Mentimeter to get engagement from the students and getting feedback for us as teachers was useful for future improvements of the course. At the same time it allowed students to test out some of their understanding and learning in a collective environment. 
